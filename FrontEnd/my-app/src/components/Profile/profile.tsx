    ...
    <>
      <div >
        ...
        <div className='mb-20 mt-10'>
          <div className='flex'>
            <Link to="editprofile" className=' border w-1/3 justify-center flex-col flex py-16 rounded-lg mx-2 transition-all duration-200 hover:bg-whiteGrayComment select-none cursor-pointer active:scale-105 active:duration-100'>
            ...
            <Link to="profilehistory" className=' border w-1/3 justify-center flex-col flex py-16 rounded-lg mx-2 transition-all duration-200 hover:bg-whiteGrayComment select-none cursor-pointer active:scale-105 active:duration-100'>
