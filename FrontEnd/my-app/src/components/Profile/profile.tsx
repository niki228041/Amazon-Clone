  ...
  return (
    <div>
      ...
      <div style={{ display: "inline-flex", flexWrap: "wrap" }}>
        <Link to="/editprofile">
          <div style={{ borderWidth: "2px", borderRadius: "20px", height: "250px", width: "450px", marginLeft: "250px", marginTop: "90px", display: "inline-flex" }}>
        ...
        <Link to="/payment">
          <div style={{ borderWidth: "2px", borderRadius: "20px", height: "250px", width: "450px", marginLeft: "20px", marginTop: "90px", display: "inline-flex" }}>
      ...
      <div style={{ display: "inline-flex" }}>
        <Link to="/security">
          <div style={{ borderWidth: "2px", borderRadius: "20px", height: "250px", width: "450px", marginLeft: "500px", marginTop: "20px", display: "inline-flex" }}>
        ...
        <Link to="">
          <div style={{ borderWidth: "2px", borderRadius: "20px", height: "250px", width: "450px", marginLeft: "20px", marginTop: "20px", display: "inline-flex" }}>
