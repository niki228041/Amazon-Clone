...
function Help() {
   ...
   const [selectedQuestion,setSelectedQuestion]=  useState("Часті запитання");
    ...
    <div className=' bg-darkBlueColor'>
        ...
        <div className='w-10/12 mx-auto text-white mt-10 pb-16'>
            ...
            <div className=' grid-cols-3 grid gap-3 gap-y-6'>
                <div className=' bg-white p-2 rounded-sm text-black flex py-4 hover:bg-grayColorForBorder cursor-pointer'>
        ...
        <div className=' bg-white pt-10'>
            <div className='w-10/12 mx-auto'>
                ...
                <div className=' grid grid-cols-5 gap-4 mt-2'>
                    <div>
                        <div onClick={()=>setSelectedQuestion("Часті запитання")} className={classNames('  text-black  py-2 px-4 rounded-lg cursor-pointer mb-1 transition-all',{"bg-darkBlueColor text-white":selectedQuestion=="Часті запитання"})}>
                            <div className={classNames(' text-lg pl-2 font-semibold')}>Часті запитання</div>
                        </div>

                        <div onClick={()=>setSelectedQuestion("Де моя посилка")} className={classNames('  text-black  py-2 px-4 rounded-lg cursor-pointer mb-1 transition-all',{"bg-darkBlueColor text-white":selectedQuestion=="Де моя посилка"})}>
                            <div className={classNames(' text-lg pl-2 font-semibold')}>Де моя посилка</div>
                        </div>
                        <div onClick={()=>setSelectedQuestion("Доставка")} className={classNames('  text-black  py-2 px-4 rounded-lg cursor-pointer mb-1 transition-all',{"bg-darkBlueColor text-white":selectedQuestion=="Доставка"})}>
                            <div className={classNames(' text-lg pl-2 font-semibold')}>Доставка</div>
                        </div>
                    ...
                    <div className=' col-span-4 grid grid-cols-2 gap-5 mb-10'>
                        <div>
                            <div className='p-3 px-6 border'>
                                <p className=' font-medium'>Знайти втрачену посилку, яка відображається як “Доставлена” </p>
                                <span className='text-sm'>Більшість посилок доставляються вчасно, але іноді трекер може показувати статус “Доставлено” коли Ви ще не отримали посилку </span>
                            </div>
                        </div>
                        <div>
                            <div className='p-3 px-6 border'>
