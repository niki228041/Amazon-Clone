  ...
  return (
    <div>
        ...
        <div>
            ...
            <div>   
                <svg className='avatar' width="129" height="129" viewBox="0 0 129 129" fill="none" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
                    <circle cx="64.5" cy="64.5" r="64" fill="url(#pattern0)" fill-opacity="0.6" stroke="#D9D9D9"/>
                    <defs>
        ...
        <div>
            ...
            <div>
                ...
                <select className="personalInfoInput input-4" placeholder="Стать">
        ...
        <div>
            ...
            <div>
                <select className="personalInfoInput input-8" placeholder="Країна">
                <option selected>Країна</option>
                    <option value="Country">Україна</option>
                    <option value="Country">Швейцарія</option>
                    <option value="Country">Норвегія</option>
                    <option value="Country">Швеція</option>
                    <option value="Country">Канада</option>
                    <option value="Country">Австралія</option>
                    <option value="Country">Нідерланди</option>
                    <option value="Country">Німеччина</option>
                    <option value="Country">Данія</option>
                    <option value="Country">Сполучені Штати</option>
                    <option value="Another">Інше</option>
                </select>
