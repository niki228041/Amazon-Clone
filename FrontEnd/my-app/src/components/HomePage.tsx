                ...
                <div className='overflow-x-hidden flex relative h-[359px] w-full px-4'>
                    <div className="flex  absolute self-center transition-all duration-500" style={{ transform: `translateX(-${smallIconOffset2}px)` }}>
                        ...
                        <div className="flex flex-row gap-x-[190px] shrink-0">
                            ...
                            {/* FIX TO 3, 6 */}
                            {productsWithDiscounts?.slice(2, 5).map((product: any) => (
            ...
            <div className="our-products bg-[#F7F7F7]">
                <div className="our-products-header flex justify-between">
                    ...
                    <div className="our-products-header-variants">
                        <h3
                            className="text-[#002A42] mt-0 mb-0 font-normal"
                            onClick={() => {
                                setSelectedCategory("Bin Bakar Електроніка"); // Измените на соответствующий идентификатор категории
                                console.log("Select category 1::", selectedCategory); // Добавьте console.log для отслеживания
                              }}
                        >
                            Прості щомісячні платежі
                        </h3>
                        <h3
                            className="mt-0 mb-0 font-normal text-[black]"
                            onClick={() => {
                                setSelectedCategory("Електроніка"); // Измените на соответствующий идентификатор категории
                                console.log("Select category 8::", selectedCategory); // Добавьте console.log для отслеживания
                              }}
                        >
                            розпродаж
                        </h3>
                        <h3
                            className="mt-0 mb-0 font-normal text-[black]"
                            onClick={() => {
                                setSelectedCategory("Естамп"); // Измените на соответствующий идентификатор категории
                                console.log("Select category 51::", selectedCategory); // Добавьте console.log для отслеживания
                              }}
                        >
                            Топ
                        </h3>
                ...
                <div className="our-products-main">
                    ...
                    <div className="container-main-cards">
                        <div className="first-container-main">
                            {productsWithDiscounts?./*filter((product) => product.category === selectedCategory)*/slice(0, 4).map((product: any) => (
                        ...
                        <div className="second-container-main">
                            {productsWithDiscounts?./*filter((product) => product.category === selectedCategory)*/slice(4, 8).map((product: any) => (
                                <div className="our-products-main-card">
                                    <span>{product.category}</span>
                                    <h4 className="mt-0 mb-0 font-normal text-[black] whitespace-nowrap overflow-hidden text-ellipsis block">{product.name}</h4>
                                    <img src={product.image} />
