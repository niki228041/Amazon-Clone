...
const AdminSite=()=> {
    ...
    const getList=()=>{
      ...
      switch(list){
        ...
        case "categories" :return categoryList(categories.payload,isSuccessCategory,deleteCategoryHandle);
      }
    }
  ...
  const categoryList=(data:Category[],isSuccess:boolean,deleteCategory:any)=>{
    return <>
      {
