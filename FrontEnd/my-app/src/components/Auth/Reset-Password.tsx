    ...
    return (
        <div className='overlogin'>
            <div className="leftside">
                ...
                <div style={{ fontSize: "40px", fontWeight: "500", marginLeft: "350px", marginTop: "50px", marginBottom: "50px", }}>
                    <a style={{ color: "rgb(109, 104, 104)" }}>
                        Зміна паролю
                    </a>
                </div>
                <div style={{ fontSize: "15px", fontWeight: "500", marginLeft: "330px", marginTop: "15px", marginBottom: "15px", }}>
                    <a style={{ color: "rgb(109, 104, 104)" }}>
