    ...
    return (
        <div className='overlogin'>
            <div className="leftside">
                ...
                <div style={{ fontSize: "40px", fontWeight: "500", marginLeft: "320px", marginTop: "50px", marginBottom: "50px", }}>
                ...
                <div style={{ fontSize: "15px", fontWeight: "500", marginLeft: "350px", marginTop: "15px", marginBottom: "15px", }}>
                    <a style={{ color: "rgb(109, 104, 104)" }}>
                        Введіть адрес електронної адреси
                    </a>
                </div>
                <div style={{ display: "flex", flexWrap: "wrap", height: "0px" }}>
                ...
                <div style={{ marginTop: "80px" }}>
                    ...
                    <div style={{ marginLeft: "280px", }}>
                        <button
                            style={{ borderRadius: "7px", color: "white", background: "#FF9A02", height: "40px", width: "400px", marginTop: "30px" }}
                            type="submit"
